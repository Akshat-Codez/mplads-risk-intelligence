...
import { ShieldCheck, Award, ArrowRight, Building2, CheckCircle2, FileText } from '../components/common/Icons';

export const Home: React.FC = () => {
  const navigate = useNavigate();

  return (
    <div className="min-h-screen bg-[#FBFBF9] text-slate-900 font-serif">
      <PublicNavbar />

      {/* Hero Section */}
      <section className="relative bg-gradient-to-b from-[#0A2540] via-[#002B49] to-[#0A2540] text-white py-16 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-4xl lg:text-5xl font-black leading-tight tracking-tight font-serif text-white">
              Members of Parliament <br />
              <span className="text-amber-400">Local Area Development Scheme</span>
            </h1>

            <p className="text-slate-200 text-sm font-sans leading-relaxed max-w-2xl">
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center">
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 text-center space-y-4 shadow-2xl">
              <AshokaChakra size={96} className="mx-auto" />
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 -mt-8 relative z-20 font-sans">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div onClick={() => navigate('/login?role=MINISTER')} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-md hover:shadow-xl transition cursor-pointer space-y-3 group border-t-4 border-t-amber-500">
          ...
          <div onClick={() => navigate('/login?role=MINISTRY')} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-md hover:shadow-xl transition cursor-pointer space-y-3 group border-t-4 border-t-blue-600">
          ...
          <div onClick={() => navigate('/login?role=STATE')} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-md hover:shadow-xl transition cursor-pointer space-y-3 group border-t-4 border-t-emerald-600">
          ...
          <div onClick={() => navigate('/login?role=DISTRICT')} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-md hover:shadow-xl transition cursor-pointer space-y-3 group border-t-4 border-t-purple-600">
      ...
      <section id="about-mplads" className="max-w-7xl mx-auto px-6 py-12 space-y-8 border-t border-slate-200 font-sans">
